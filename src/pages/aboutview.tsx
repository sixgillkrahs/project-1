        ...
        <div className="container">
            <div className="row gx-5">
                ...
                <div className="col-lg-7">
                    ...
                    <p>Chúng tôi luôn coi bệnh nhân là trung tâm và sức khoẻ của con người là điều quý giá nhất. Chăm sóc sức khoẻ toàn diện và cá thể hoá phác đồ là mục tiêu hoạt động&nbsp;của chúng tôi. Tầm nhìn phát triển AMCVN là hệ thống Y học Gia đình toàn diện, cơ sở y tế hiện đại, đáp ứng đa dạng các nhu cầu về sức khoẻ của con người.     &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;</p>
                    <div className="row g-3 pt-3">
                        ...
                        <div className="col-sm-3 col-6">
                            <div className="bg-light text-center rounded-circle py-4">
                              ...
                              <h6 className="mb-0">Nghiên cứu khoa học&nbsp;</h6>
                                <h6 className="mb-0"><small className="d-block text-primary">Đa ngành, thực chứng</small></h6>
                            </div>
                        </div>
                        <div className="col-sm-3 col-6">
                            <div className="bg-light text-center rounded-circle py-4">
    ...
    <div className="container-fluid bg-primary my-5 py-5">
        <div className="container py-5">
            <div className="text-center mx-auto mb-5" style={{maxWidth: "500px"}}>
                <h5 className="d-inline-block text-white text-uppercase border-bottom border-5"> Mô hình</h5>
              <p>&nbsp;</p>
<h1 className="display-4 mb-4">Mô hình Y Học Gia Đình Hoa Kỳ&nbsp;&nbsp;</h1>
                <h5 className="text-white fw-normal">Cá thể hoá phác đồ chăm sóc sức khoẻ toàn diện cần sự phối hợp của tất cả chuyên môn và đội ngũ bác sĩ hiểu biết toàn diện, có khả năng chăm sóc bệnh nhân ở bất kỳ giai đoạn nào trong cuộc đời, bất kỳ môi trường nào (nhà ở, trường học, công sở hay trên giường bệnh)</h5>
            </div>
            <div className="mx-auto" style={{width: "100%", maxWidth: "600px"}}> </div>
        </div>
    </div>
  ...
  <div className="row g-0 bg-light rounded overflow-hidden">
    ...
    <div className="col-12 col-sm-7 h-100 d-flex flex-column">
      <div className="mt-auto p-4">
        ...
        <p className="m-0">Tiến sĩ di truyền học, USA. Thạc sĩ quản lý hệ thống y tế, USA. Bác sĩ Phụ Trách Chuyên Môn-Family Medicine-Washington, USA. Giám Đốc Y Tế-FPT Healthcare, Vietnam. Chủ Tịch HĐQT | CEO - American Medical Clinic, Vietnam. Chủ Tịch HĐQT | CEO United Global Medical, Vietnam. </p>
      </div>
      <div className="d-flex mt-auto border-top p-4"> <a className="btn btn-lg btn-primary btn-lg-square rounded-circle me-3" href="#"><i className="fab fa-twitter"></i></a> <a className="btn btn-lg btn-primary btn-lg-square rounded-circle me-3" href="#"><i className="fab fa-facebook-f"></i></a> <a className="btn btn-lg btn-primary btn-lg-square rounded-circle" href="#"><i className="fab fa-linkedin-in"></i></a></div>
    </div>
  </div>
