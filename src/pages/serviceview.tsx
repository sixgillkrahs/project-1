          ...
          <div className="container">
              ...
              <div className="row g-5">
                  ...
                  <div className="col-lg-4 col-md-6">
                      <div className="service-item bg-light rounded d-flex flex-column align-items-center justify-content-center text-center">
                          <div className="service-icon mb-4">
                          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" style={{width: "45px"}}><path d="M543.8 287.6c17 0 32-14 32-32.1c1-9-3-17-11-24L309.5 7c-6-5-14-7-21-7s-15 1-22 8L10 231.5c-7 7-10 15-10 24c0 18 14 32.1 32 32.1l32 0 0 160.4c0 35.3 28.7 64 64 64l320.4 0c35.5 0 64.2-28.8 64-64.3l-.7-160.2 32 0zM256 208c0-8.8 7.2-16 16-16l32 0c8.8 0 16 7.2 16 16l0 48 48 0c8.8 0 16 7.2 16 16l0 32c0 8.8-7.2 16-16 16l-48 0 0 48c0 8.8-7.2 16-16 16l-32 0c-8.8 0-16-7.2-16-16l0-48-48 0c-8.8 0-16-7.2-16-16l0-32c0-8.8 7.2-16 16-16l48 0 0-48z"/></svg>                          </div>
...
<div className="row gx-5">
      <div className="col-lg-6 mb-5 mb-lg-0">
                ...
                <a className="btn btn-dark rounded-pill py-3 px-5 me-3" href="">Đặt khám cùng bác sĩ</a> <a className="btn btn-outline-dark rounded-pill py-3 px-5" href="">Tìm hiểu thêm</a> </div>
                  ...
                  <form>
                    <div className="row g-3">
                      <div className="col-12 col-sm-6">
                        <select name="select" className="form-select bg-light border-0" style={{height: "40px"}}>
                      ...
                      <div className="col-12 col-sm-6">
                        <input type="text" className="form-control bg-light border-0" placeholder="Họ và tên" style={{height: "40px"}}/>
                      </div>
                      <div className="col-12 col-sm-6">
                        <input type="email" className="form-control bg-light border-0" placeholder="Email" style={{height: "40px"}}/>
                      </div>
                      <div className="col-12 col-sm-6">
                        <div className="Date" id="date2" data-target-input="nearest">
                          <input type="text"
                                            className="form-control bg-light border-0 datetimepicker-input"
                                            placeholder="Ngày" data-target="#date" data-toggle="datetimepicker" style={{height: "40px"}}/>
                        </div>
                      </div>
                      <div className="col-12 col-sm-6">
                        <div className="time" id="time2" data-target-input="nearest">
                          <input type="text"
                                            className="form-control bg-light border-0 datetimepicker-input"
                                            placeholder="Thời gian" data-target="#time" data-toggle="datetimepicker" style={{height: "40px"}}/>
                        </div>
                      </div>
                ...
                <div className="col-lg-8">
                    <div className="owl-carousel testimonial-carousel">
                        <div className="testimonial-item text-center">
                            ...
                            <h6 className="fw-normal text-primary mb-3">Đái tháo đường, suy thận, mỡ máu</h6>
                        </div>
                        <div className="testimonial-item text-center">
                            <div className="position-relative mb-5">
                        ...
                        <div className="testimonial-item text-center">
                         <div className="position-relative mb-5"> <img className="img-fluid rounded-circle mx-auto" src="/src/assets/img/Khatvong.jpg" alt="" style={{width:"120px"}}/>
                            <div className="position-absolute top-100 start-50 translate-middle d-flex align-items-center justify-content-center bg-white rounded-circle" style={{width: "60px", height: "60px"}}> <i className="fa fa-quote-left fa-2x text-primary"></i> </div>
                          </div>
